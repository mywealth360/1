/*
  # Fix Subscription Period Validation

  1. Changes
    - Update admin_update_user_plan function to properly validate subscription periods
    - Add support for copy_trade_access optional module
    - Ensure proper handling of optional modules in user_plans
*/
