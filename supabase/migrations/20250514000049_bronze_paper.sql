/*
  # Add Extra Leverage Support

  1. Changes
    - Add support for extra_leverage in admin_update_user_plan function
    - Update get_all_users function to include extra_leverage in optional_modules
