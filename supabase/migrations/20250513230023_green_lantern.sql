/*
  # Fix Plan Synchronization and Admin Panel

  1. Changes
    - Fix admin_update_user_plan function with proper subscription period validation
    - Update get_all_users function to include optional modules
    - Add refresh_client_state trigger for real-time updates
    - Properly drop and recreate get_user_plan function to avoid return type errors
*/
