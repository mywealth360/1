/*
  # Remove Quarterly Option from Subscription Period

  1. Changes
    - Update admin_update_user_plan function to validate subscription periods
    - Add validation for subscription periods (monthly, semiannual, annual)
    - Remove quarterly option from valid subscription periods
*/

-- Drop the existing function first
DROP FUNCTION IF EXISTS admin_update_user_plan(uuid, text, text, text);

-- Create new version of the function with subscription period validation
